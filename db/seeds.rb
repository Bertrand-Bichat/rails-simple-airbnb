...
Flat.create!(
  name: 'New apartment near Big Ben',
  address: '20 Diana Gardens London W1 4RG',
  description: 'A huge apartment near the legendary Big Ben, one of the most visited London monument. Good light, you have a kitchen and a bedroom.',
  price_per_night: 85,
  number_of_guests: 1
)
